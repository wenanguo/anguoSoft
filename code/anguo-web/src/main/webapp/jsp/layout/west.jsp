...
<script type="text/javascript">
	...
	function addTab(params) {
	    ...
	    if(params.attributes.url==""){
	    	return false;
	    }
	
		var iframe = '<iframe src="' + params.attributes.url + '" frameborder="0" style="border:0;width:100%;height:98%;"></iframe>';
		var t = $('#index_tabs');
		var opts = {
	...
	//初始化菜单树
	$('#menu_tree').tree({
		url:'commonSysAuthority/tree.htm',
		method:'get',
		animate:true,
		onClick: function(node){
