...
<script type="text/javascript" src="jsp/news/js/newsConfigManager.js"></script>
...
<body class="easyui-layout" data-options="fit:true">
  	...
  	<input id='basePath' style="display:none;" value="<%=basePath%>" />
    	<div data-options="region:'center',border:false">
	    	<table id="newsConfigList"></table>
	    	<div id="add" title="新增" style="width:600px;height:520px;"></div>
			<div id="edit" title="修改" style="display:none;width:600px;height:520px;"></div>
	    </div>
