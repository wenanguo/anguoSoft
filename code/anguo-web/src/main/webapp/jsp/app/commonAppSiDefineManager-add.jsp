			...
			<form id="addForm" method="post">
				<table class="table" width="100%" border='0' cellspacing='0' cellpadding='1'>
					...
					<tr>
						...
						<td>
							<input id="siName" name="siName" class="easyui-validatebox" style="width:240px;"  validType="length[0,25]" />
						</td>
					</tr>
					<tr>
						<td style="text-align:left;font-size:12px;">服务类名:<span style="color:red">*</span></td>
						<td>
							<input id="siServiceName" name="siServiceName" class="easyui-validatebox" style="width:240px;"  validType="length[0,25]" />
						</td>
					</tr>
					<tr>
						<td style="text-align:left;font-size:12px;">服务方法名:<span style="color:red">*</span></td>
						<td>
							<input id="siServiceMethod" name="siServiceMethod" class="easyui-validatebox" style="width:240px;"  validType="length[0,25]" />
						</td>
					</tr>
