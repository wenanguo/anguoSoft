...
<script type="text/javascript" src="jsp/report/js/blManager.js"></script>
...
<body class="easyui-layout" data-options="fit:true">
    	...
    	<input id='basePath' style="display:none;" value="<%=basePath%>" />
	    	...
	    	<div id="add" title="新增" style="width:600px;height:380px;"></div>
			<div id="edit" title="修改" style="display:none;width:100px;height:380px;"></div>
	    </div>
